package com.triompha.common.web.http;
...
public class HttpClientUtil {
    ...
    private void init() throws Exception {
        ...
        params.setMaxTotalConnections(640);
    ...
    public PostMethod post(HttpUrl httpUrl) throws Exception {
        ...
        if (result != 200)
            throw new Exception("##wrong HttpClient.executeMethod post method-result="+result);
    ...
    public PostMethod postNew(HttpUrl httpUrl) throws Exception {
        ...
        StringRequestEntity requestEntity = new StringRequestEntity(httpUrl.getRequetsBody(), httpUrl.getContentType(),encoding);
        post.setRequestEntity(requestEntity);
        DefaultHttpParams.getDefaultParams().setParameter("http.protocol.cookie-policy", CookiePolicy.BROWSER_COMPATIBILITY);
        int result = httpClient.executeMethod(config, post);
        if (result != 200){
            throw new Exception("##wrong HttpClient.executeMethod postnew method-result="+result);
        }
        return post;
    }
    ...
    public GetMethod get(HttpUrl httpUrl) throws Exception {
        ...
        if (result != 200)
            throw new Exception("wrong HttpClient.executeMethod get method result="+result);
        return get;
    }
